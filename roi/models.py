...
class Users(db.Model,UserMixin):
    ...
    address =           Column("address",Text,default="none")
    city =              Column("city",Text,default="none")
    state =             Column("state",Text,default="none")
    zip =               Column("zip",Text,default="none")
    about_me =          Column("about_me",Text,default=" ")
